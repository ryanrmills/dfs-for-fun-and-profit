...
public class Practice {
  ...
  public boolean allOdd(Vertex<Integer> vertex, Set<Vertex<Integer>> seen){
    ...
    seen.add(vertex);
    boolean flag = vertex.data % 2 != 0;
    for (Vertex<Integer> neighbor : vertex.neighbors){
      flag = flag && allOdd(neighbor, seen);
    }
    return flag;
  }
  ...
  private boolean hasStrictlyIncreasingPath(Vertex<Integer> start, Vertex<Integer> end, Set<Vertex<Integer>> seen) {
    if (start.equals(end)) {
        return true;
    }
